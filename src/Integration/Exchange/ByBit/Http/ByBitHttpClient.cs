...
namespace ByBit.Http;

/// <summary>
/// Provides HTTP client functionality for interacting with the ByBit API.
/// </summary>
public sealed class ByBitHttpClient(string baseUrl/*, string? apiKey = null, string? secret = null*/)
{
    ...
    /// <summary>
    /// Sends a public HTTP request to the ByBit API with optional query parameters and content.
    /// </summary>
    /// <param name="requestUri">The request URI relative to the base URL.</param>
    ...
    /// <returns>A task that represents the asynchronous operation. The task result contains the response as a JSON string.</returns>
